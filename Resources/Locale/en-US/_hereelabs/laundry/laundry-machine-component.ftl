...
laundry-machine-examined-state = It is currently [color=white]{ -laundry-machine-state-name(state: $state) }[/italic].
laundry-machine-examined-mode = It is currently set to [color=white]{ -laundry-machine-state-name(state: $mode) }[/color].

laundry-machine-switch-wash-cycle = Switch to { -laundry-machine-wash-cycle-name(cycle: $cycle) }
laundry-machine-switched-wash-cycle = Switched to { -laundry-machine-wash-cycle-name(cycle: $cycle) }.

laundry-machine-switch-dry-cycle = Switch to { -laundry-machine-dry-cycle-name(cycle: $cycle) }
laundry-machine-switched-dry-cycle = Switched to { -laundry-machine-dry-cycle-name(cycle: $cycle) }.

laundry-machine-switch-mode = Switch to { -laundry-machine-mode-name(mode: $mode) }
