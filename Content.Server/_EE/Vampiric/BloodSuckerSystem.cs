...
using Content.Shared._EE.Vampiric;
    ...
    public sealed class BloodSuckerSystem : EntitySystem
    {
        ...
        private void AddSuckVerb(EntityUid uid, BloodSuckerComponent component, GetVerbsEvent<InnateVerb> args)
        {
            ...
            InnateVerb verb = new()
            {
                Act = () =>
                {
                    StartSuckDoAfter(uid, args.Target, component, bloodstream); // start doafter
                },
        ...
        public bool TrySuck(EntityUid bloodsucker, EntityUid victim, BloodSuckerComponent? bloodsuckerComp = null)
        {
            ...
            if (!_solutionSystem.TryGetSolution(stomachList[0].Comp1.Owner, StomachSystem.DefaultSolutionName, out var stomachSolution))
                return false;
            ...
            _stomachSystem.TryTransferSolution(stomachList[0].Comp1.Owner, temp, stomachList[0].Comp1);
