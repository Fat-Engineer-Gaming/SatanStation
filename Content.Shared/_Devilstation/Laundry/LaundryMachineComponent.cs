...
namespace Content.Shared._Devilstation.Laundry;
...
public sealed partial class LaundryMachineComponent : Component
{
    ...
    [DataField, AutoNetworkedField]
    public SoundSpecifier FillSound = new SoundPathSpecifier("/Audio/_Devilstation/Machines/laundry_fillwater.ogg");

    [DataField, AutoNetworkedField]
    public SoundSpecifier SpinSound = new SoundPathSpecifier(
        "/Audio/_Devilstation/Machines/laundry_spin.ogg",
        AudioParams.Default.WithLoop(true)
    );

    [DataField, AutoNetworkedField]
    public SoundSpecifier StartSpinSound = new SoundPathSpecifier("/Audio/_Devilstation/Machines/laundry_spinstart.ogg");

    [DataField, AutoNetworkedField]
    public SoundSpecifier FastSpinSound = new SoundPathSpecifier(
        "/Audio/_Devilstation/Machines/laundry_spinfast.ogg",
        AudioParams.Default.WithLoop(true)
    );
